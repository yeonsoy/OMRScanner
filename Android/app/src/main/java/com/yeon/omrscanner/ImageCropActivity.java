...
import com.yeon.omrscanner.libraries.NativeClass;
import com.yeon.omrscanner.libraries.PolygonView;
...
public class ImageCropActivity extends Activity {
    ...
    private void initializeElement() {
        ...
        ImageScanBtn = findViewById(R.id.ImageScanBtn);
        ...
        ImageScanBtn.setOnClickListener(ImageScanBtnClick);
    }
    ...
    private void initializeCropping() {
        ...
        int padding = 16;//getResources().getDimension(R.dimen.scanPadding);
    ...
    private View.OnClickListener ImageScanBtnClick = new View.OnClickListener() {
        @Override
    ...
    private List<PointF> getContourEdgePoints(Bitmap tempBitmap) {
        ...
        if(point2f == null) {
            Toast.makeText(getApplicationContext(), "직접 영역을 지정해주세요", Toast.LENGTH_SHORT).show();
            return null;
        }
